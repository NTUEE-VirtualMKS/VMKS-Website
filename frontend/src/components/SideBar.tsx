    ...
    return(
        ...
        <div className="w-20 h-full left-0 top-0 fixed bg-slate-900 rounded-2xl border border-zinc-600 flex flex-col">
            ...
            <div className="w-full flex flex-col justify-center items-center p-2">
                ...
                <div className="flex-wrap px-1 text-white text-xs font-medium font-inter uppercase tracking-wide">LIKE</div>
            </div>
            <div className="flex flex-col gap-2 flex-1 overflow-y-auto">
                <button className="w-full flex flex-col justify-center items-center p-1">
                    <img className="w-full object-cover" src="https://via.placeholder.com/60x60" alt="Placeholder" />
                </button>
                <button className="w-full flex flex-col justify-center items-center p-1">
                    <img className="w-full object-cover" src="https://via.placeholder.com/60x60" alt="Placeholder" />
                </button>
            ...
            <button className="w-full flex flex-col justify-center items-center p-2">
                ...
                <div className="flex-wrap px-1 text-white text-xs font-medium font-inter uppercase tracking-wide">ADD</div>
            </button>
        </div>
        </>
    );
