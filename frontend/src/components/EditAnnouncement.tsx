...
const EditAnnouncement = () => {
  ...
  const announcement = allAnnouncements.find((a: { id: string }) => a.id === id);
...
//   if (error) return `Error! ${error.message}`;
  ...
  const formSubmit = ({ editTitleNow, editContentNow }: { editTitleNow: string; editContentNow: string }) => {
            ...
            {/* <> */}
              ...
              <Dialog open={visible} onClose={handleClose}>
                ...
                <DialogActions>
                  ...
                  <Button onClick={() => formSubmit({ editTitleNow, editContentNow })} color="primary">
                    提交
                  </Button>
                </DialogActions>
              </Dialog>
