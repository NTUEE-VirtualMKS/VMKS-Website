import { BorrowType } from "@/shared/type";
...
export const unborrowedData: BorrowType[] = [
  {
    id: 1,
    star: false,
    figure: "https://http.cat/200",
    name: "Arduino",
...
export const borrowingData: BorrowType[] = [
  {
    id: 1,
    star: false,
    figure: "https://http.cat/429",
...
export const borrowedData: BorrowType[] = [
  {
    id: 1,
    star: false,
    figure: "https://http.cat/200",
