...
const PostView: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Link to="/BlogDashboard" className="text-blue-500 hover:text-blue-600 mb-4 inline-block">&larr; Back to Dashboard</Link>
      {article!.imageURL && (
        <img src={article!.imageURL} alt={article!.title} className="w-full h-64 object-cover mb-4 rounded-lg" />
      )}
      <h1 className="text-3xl font-bold mb-4 text-gray-800 dark:text-white">{article!.title}</h1>
